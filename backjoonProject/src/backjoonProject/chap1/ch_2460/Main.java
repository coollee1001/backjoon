 ...
 * 
 * input : 각 역에서 내린 사람 수와 탄 사람 수가 빈칸을 사이에 두고 첫째 줄부터 열 번째 줄까지 역 순서대로 한 줄에 하나씩 주어진다. 
 * 
 * output : 첫째 줄에 최대 사람 수를 출력한다.  
 * 
 * @author siwon
 *
 */
public class Main {
	private final static int maxLimitLine = 10; // 총 몇줄
    public static void main(String[] args) throws IOException {
    	BufferedReader bf = new BufferedReader(new InputStreamReader(System.in));
    	int sum = 0;
    	int max = 0;
    	for(int i=0; i<maxLimitLine; i++) {
